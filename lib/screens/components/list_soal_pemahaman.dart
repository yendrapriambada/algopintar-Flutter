...
import 'list_soal_pemahaman_table.dart';

class ListSoalPemahaman extends StatefulWidget {
  final List<Quizmodel> listQuiz;
  final String idMateri;

  const ListSoalPemahaman(
      {Key? key, required this.listQuiz, required this.idMateri})
      : super(key: key);

  @override
  State<ListSoalPemahaman> createState() => _ListSoalPemahamanState();
}

class _ListSoalPemahamanState extends State<ListSoalPemahaman> {
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Text(
                  "Data Soal Pemahaman tiap Materi",
                style: TextStyle(
          ...
          Expanded(
            child: ListSoalPemahamanTable(listQuiz: widget.listQuiz),
          )
        ],
      ),
    );
