...
class ListSoalPemahamanTable extends StatefulWidget {
  final List<Quizmodel> listQuiz;

  const ListSoalPemahamanTable({Key? key, required this.listQuiz}) : super(key: key);

  @override
  _ListSoalPemahamanTableState createState() => _ListSoalPemahamanTableState();
}

class _ListSoalPemahamanTableState extends State<ListSoalPemahamanTable> {
  ...
  void _editSoal(String quizId) {
    DatabaseReference pertemuanRef =
        FirebaseDatabase.instance.ref().child('soalPemahamanList').child(quizId);
