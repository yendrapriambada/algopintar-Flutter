...
class _PertemuanTableState extends State<PertemuanTable> {
  ...
  void _deletePertemuan(String pertemuanId) async {
    DatabaseReference _pertemuanRef = FirebaseDatabase.instance.ref().child('pertemuan').child(pertemuanId);
    DatabaseReference _materialListRef = FirebaseDatabase.instance.ref().child('materialList');
