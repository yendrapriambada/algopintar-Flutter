    ...
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        if (constraints.maxWidth > 700) {
          return const ForgotWebPage();
        } else {
          return const ForgotMobilePage();
        }
      },
    );
  }
...
class ForgotWebPage extends StatelessWidget {
...
class ForgotMobilePage extends StatefulWidget {
  const ForgotMobilePage({super.key});

  @override
  State<ForgotMobilePage> createState() => _ForgotMobilePageState();
}

class _ForgotMobilePageState extends State<ForgotMobilePage> {
  ...
  Future forgotPassword({required String email}) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
              content: Text('Link Reset Password berhasil dikirim ke email ${email}!'),
